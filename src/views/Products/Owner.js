            ...
            >
                ...
                <DialogContent dividers sx={{ minWidth: '500px' }}>
                    <div style={{
                        ...
                        <img style={{ width: '100px', height: '100px' }} src={`https://bikechahiye.onrender.com/${ownerDetail?.image}`} />
                    </div>
                    ...
                    <Typography gutterBottom>
                        ...
                        {`${" "}${ownerDetail?.featuredVendor}`}
                    </Typography>
                    <Typography gutterBottom>
                        <span style={{ color: 'red' }}>CNIC:</span>
                        {`${" "}${ownerDetail?.cnic}`}
                    </Typography>
                    <Typography gutterBottom>
                    ...
                    <Typography gutterBottom>
                        <span style={{ color: 'red' }}>Shop Name:</span>
