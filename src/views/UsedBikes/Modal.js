            ...
            >
                {
                    deleteBikeState
                        ?
                        <DialogTitle style={{ color: 'red' }}>Delete Conformation</DialogTitle>
                        :
                        <DialogTitle>{`${EditBike?.brand}${" "}${EditBike?.bikeNumber}`}</DialogTitle>
                }
                <DialogContent>
                    {
                        deleteBikeState ?
                            <DialogContentText id="alert-dialog-slide-description">
                                {`Are you sure you want to delete ${deleteBikeState?.brand}${" "}${deleteBikeState?.bikeNumber}.?`}
                            </DialogContentText>
                            :
                            <DialogContentText id="alert-dialog-slide-description">
